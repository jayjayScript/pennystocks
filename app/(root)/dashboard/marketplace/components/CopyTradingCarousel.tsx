...
const MOCK_TRADERS = [
  { _id: "t1", traderName: "AlphaKing",  riskLevel: "low",    rateOfChange: 28.4, averageDailyProfit: 142.50, purchases: 312, duration: "6 months" },
  { _id: "t2", traderName: "NightOwl",   riskLevel: "medium", rateOfChange: 47.2, averageDailyProfit: 285.00, purchases: 187, duration: "3 months" },
  { _id: "t3", traderName: "ZenTrader",  riskLevel: "low",    rateOfChange: 18.9, averageDailyProfit: 98.75,  purchases: 524, duration: "12 months" },
  { _id: "t4", traderName: "QuantumEdge", riskLevel: "high",  rateOfChange: -5.1, averageDailyProfit: 420.00, purchases: 94,  duration: "1 month" },
];
                  ...
                  <div className="h-full rounded-2xl border border-penny-border-default bg-penny-bg-mid p-6 flex flex-col gap-4 relative overflow-hidden group hover:border-penny-accent/30 transition-colors duration-300">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-1.5 mt-1">
                            <span className={`text-[10px] uppercase tracking-wider font-black px-2 py-0.5 rounded-md border ${riskColors[trader.riskLevel] || riskColors["low"]}`}>
                              {riskKey}
                            </span>
                          </div>
                        </div>
                    ...
                    <div className="space-y-1 relative z-10">
                      ...
                      <p
                        ...
                        style={{ color: trader.rateOfChange >= 0 ? "var(--penny-accent)" : "var(--penny-error)" }}
                      >
                    ...
                    <div className="grid grid-cols-2 gap-4 items-center pt-4 border-t border-penny-border-subtle relative z-10 mt-auto">
                      ...
                      <div className="space-y-0.5 text-right">
                        ...
                        <p className="text-white font-bold text-sm">{trader.purchases}</p>
                      </div>
                    </div>
